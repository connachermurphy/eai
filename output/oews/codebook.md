...
<!-- BEGIN CODEBOOK SECTION: oews_national -->
## OEWS national files

Generated by `pipeline/convert_oews.py`.

### `national_M{year}_dl.csv (2019-2024)`

BLS OEWS national occupational employment and wage files, converted from Excel with lowercased column names and values unchanged.
...
<!-- END CODEBOOK SECTION: oews_national -->
