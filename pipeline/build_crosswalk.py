...
update_codebook(
    OUT / "codebook.md",
    section="crosswalk",
    title="SOC 2010 to 2018 crosswalk artifacts",
    source="pipeline/build_crosswalk.py",
    files=[
        {
            "name": "soc_crosswalk_edges.csv",
            "description": (
                "Deduplicated direct crosswalk edges, one row per SOC 2010 to "
                "SOC 2018 mapping pair."
            ),
            "columns": [
        ...
        {
            "name": "soc_2010_to_group.csv",
            "description": "One row per SOC 2010 code with its crosswalk group.",
            "columns": [
                ("soc_2010", "Six-digit SOC 2010 occupation code."),
                ("title_2010", "SOC 2010 occupation title."),
        ...
        {
            "name": "soc_2018_to_group.csv",
            "description": "One row per SOC 2018 code with its crosswalk group.",
            "columns": [
                ("soc_2018", "Six-digit SOC 2018 occupation code."),
                ("title_2018", "SOC 2018 occupation title."),
                ("group_id", GROUP_ID_DEF),
